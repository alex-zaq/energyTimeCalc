...
// ТЭЦ(название, мощность, энергетические интервалы, временные интервалы, соотношение потоков) => доступность  по интервалам

// АЭС (название, даты отключений, макс отн. мощность) = доступность по интервалам

// ГЭС (название, обяз. объемы по месяцам, мощность) => доступность по интервалам

// СЭС и ВЭС (навание, мощность, набор абс. мощностей) = доступость по интервалам
